    ...
    <main class="app-content">
        ...
        <div class="row col-12">
            <div class="tile col-12 mb-4">
                ...
                <div class="row">
                    <form class="col-12" action="{{ route('district.store') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="disctrict_name">Nama Wilayah</label>
                            <input class="form-control" id="disctrict_name" type="text" name="district_name"
